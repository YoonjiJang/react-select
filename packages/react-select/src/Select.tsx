...
import {
  ...
  ScrollManager,
  RequiredInput,
} from 'react-select-shared/internal';
import { isAppleDevice } from 'react-select-shared/accessibility';
...
type State<Option, IsMulti extends boolean, Group extends GroupBase<Option>> =
  BaseState<Option, IsMulti, Group, Props<Option, IsMulti, Group>>;
